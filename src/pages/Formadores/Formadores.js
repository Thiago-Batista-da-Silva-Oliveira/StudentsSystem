...
function Formadores () {
   ...
   const HandleClass = () => {
    ...
    return (
        <>
        <div className="hideY">
           <input className="changeClassInput" placeholder="ex: 'formadores2'" onChange={(e) => setChangeClass(e.target.value)} id='text' type="text" value={changeClass} />

...
function Curso () {
   ...
   const HandleClass = () => {
    ...
    return (
        <>
          <input className="changeClassInput" placeholder="ex: 'curso2'" onChange={(e) => setChangeClass(e.target.value)} id='text' type="text" value={changeClass} />
